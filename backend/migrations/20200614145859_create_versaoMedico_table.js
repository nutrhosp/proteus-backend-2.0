exports.up = function (knex) {
  return knex.schema.createTable("versaoMedico", (table) => {
    ...
    table.string("versaoMedico_suplementacao");
    table.string("suplementacao_tipo");
    table.string("suplementacao_proteina");
    table.string("suplementacao_caloria");
    table.string("suplementacao_omega");
  });
};
