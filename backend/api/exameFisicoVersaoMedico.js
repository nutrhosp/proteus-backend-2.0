...
module.exports = (app) => {
  ...
  const get = async (req, res) => {
    const exameFisicoVersaoMedico = await knex(
      "exameFisicoVersaoMedico"
    ).select("*");
  ...
  const post = async (req, res) => {
    const examesVersaoMedico = req.body;
    await knex("exameFisicoVersaoMedico")
      .insert(examesVersaoMedico)
