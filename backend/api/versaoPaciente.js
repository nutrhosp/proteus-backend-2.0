...
module.exports = app => {
    ...
    const remove = async (req, res) => {
        try {
            ...
            const rowsDeleted = await app.db('paciente').del()
    ...
    const post = async (req, res) => {
        const { avaliacao_id, versaoPaciente_q1PesoAtual, versaoPaciente_q1PesoMes, versaoPaciente_q1PesoSemestre, versaoPaciente_q1Tamanho, versaoPaciente_q2Quantidade, versaoPaciente_q2Tipo, versaoPaciente_q2Dor, versaoPaciente_q2Outro, versaoPaciente_quadro1, versaoPaciente_quadro2, versaoPaciente_quadro3, versaoPaciente_quadro4 } = req.body;
        await knex("versaoPaciente").insert({
            avaliacao_id,
